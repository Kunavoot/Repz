...
## Agent Skills
This project contains custom skills in the `agent-skills/` directory. If you are an AI assistant (like Claude, Cursor, Copilot, etc.), you should reference these markdown files when asked to perform those specific tasks (e.g., `manage-progression.md`).
